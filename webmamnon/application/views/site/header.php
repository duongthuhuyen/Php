...
<!-- The box-header-->
	<div id="menu"><!-- the menu -->
           <ul class="menu_top">
                ...
                <li class=""><a href="<?php echo public_url();?>/site/info/view/1.html">Giới thiệu</a></li>
                <li class=""><a href="<?php echo public_url();?>/site/info/view/2.html">Hướng dẫn</a></li>
                <li class=""><a href="<?php echo public_url();?>/site/san-pham.html">Sản phẩm</a></li>
                <li class=""><a href="<?php echo public_url();?>/site/tin-tuc.html">Tin tức</a></li>
                <li class=""><a href="<?php echo public_url();?>/site/video.html">Video</a></li>
                <li class=""><a href="<?php echo public_url();?>/site/lien-he.html">Liên hệ</a></li>
